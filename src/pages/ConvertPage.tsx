        ...
        <div className="flex justify-center gap-6 px-4 py-8 max-w-[1600px] mx-auto">
            ...
            <div className="hidden lg:block w-[160px] flex-shrink-0">
                <div className="sticky top-24">
                    <AdPlaceholder id="ad-convert-left" height="600px" width="160px" />
                </div>
            </div>
            ...
            <div className="w-full max-w-3xl">
                ...
                <div className="mb-8">
                    <AdPlaceholder id="ad-convert-top" height="100px" showCoupang={true} />
                </div>
            ...
            <div className="hidden lg:block w-[160px] flex-shrink-0">
                <div className="sticky top-24">
                    <AdPlaceholder id="ad-convert-right" height="600px" width="160px" />
                </div>
            </div>
        </div>
    );
