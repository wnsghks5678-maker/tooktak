...
const PdfMergePage = () => {
    ...
    return (
        <div className="container mx-auto px-4 py-8 max-w-6xl">
            ...
            {/* Ads Top */}
            <div className="mb-8">
                <AdPlaceholder id="ad-pdfmerge-top" className="w-full h-24" showCoupang={true} />
            </div>

            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                {/* Left Sidebar Ad */}
                <div className="hidden lg:block lg:col-span-2">
                    <AdPlaceholder id="ad-pdfmerge-left" className="w-full h-[600px] sticky top-4" />
                </div>
                ...
                {/* Right Sidebar Ad */}
                <div className="hidden lg:block lg:col-span-2">
                    <AdPlaceholder id="ad-pdfmerge-right" className="w-full h-[600px] sticky top-4" />
                </div>
            </div>

            {/* Ads Bottom */}
            <div className="mt-8">
                <AdPlaceholder id="ad-pdfmerge-bottom" className="w-full h-24" showCoupang={true} />
            </div>
        </div>
    );
};
