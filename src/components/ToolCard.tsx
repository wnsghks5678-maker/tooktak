...
const ToolCard = ({
    ...
    const content = (
        ...
        >
            ...
            {isComingSoon && (
                <span className="bg-amber-50 text-amber-600 text-xs font-medium px-2.5 py-1 rounded-full border border-amber-100 mb-2">
                    Coming Soon
                </span>
            )}
            <h3 className={`text-base font-bold text-gray-800 mb-2 transition-colors ${titleClassName}`}>
                {title}
            </h3>
